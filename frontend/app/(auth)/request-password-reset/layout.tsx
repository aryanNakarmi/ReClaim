        ...
        <div className="min-h-screen bg-[#F8F5F0] flex">
            <div className="hidden lg:flex lg:w-[420px] bg-[#1B2A4F] flex-col justify-between p-10 text-white">
                ...
                <div className="space-y-4">
                    <h2 className="text-2xl font-bold leading-tight">Forgot your password?</h2>
                    <p className="text-white/60 text-sm leading-relaxed">No worries. Enter your email and we'll send you a reset link.</p>
                </div>
